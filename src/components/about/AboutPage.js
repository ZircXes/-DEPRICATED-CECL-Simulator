  ...
  render() {
    return (
      <div>
        ...
        <h3>Credit Models</h3>
        <p>Credit models employed in this tool may not necessarily be classified as models as described in <a href="https://www.federalreserve.gov/supervisionreg/srletters/sr1107a1.pdf" target="_blank">SR 11-7</a>. No validation or guarantee has been provided as to the reliability of these models/tools.</p>
